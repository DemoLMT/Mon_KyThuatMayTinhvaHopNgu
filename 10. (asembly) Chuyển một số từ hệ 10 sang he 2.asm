...
.Data
    ...
    string DB 10 dup ('$'); nhap vao 1 chuoi toi da 5 ky tu
.Code
main proc
    MOV AX, @Data
   ...
   ;Nhap so dang chuoi:    
    MOV AH,10
    LEA DX,string ; nhap chuoi str  
    INT 21h
   ;Chuyen chuoi thanh so:
    MOV CL,[string+1] ; lay so ky tu cua chuoi ( vd :cl=2 )
    LEA SI, string+2 ; tro den dia chi cua ky tu dau tien cua chuoi str
    MOV AX, 0 ; ax=0 123
